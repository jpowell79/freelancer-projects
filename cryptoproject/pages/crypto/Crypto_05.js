...
import crypto_05_contract from '../../components/crypto/contract/crypto_05_contract';
...
class Crypto_05 extends Component {
    static defaultData = getDefaultCrypto({index: 5});
...
const mapStateToProps = (state) => {
    ...
    let cryptoData = crypto.filter(data =>
        data.index === Crypto_05.defaultData.index
    )[0];
