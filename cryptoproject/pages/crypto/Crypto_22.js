...
import crypto_22_contract from '../../components/crypto/contract/crypto_22_contract';
...
class Crypto_22 extends Component {
    static defaultData = getDefaultCrypto({index: 22});
    ...
    static fetchContract(){
        return fetchCryptoContract(crypto_22_contract, Crypto_22.defaultData.index);
    }
...
const mapStateToProps = (state) => {
    ...
    let cryptoData = crypto.filter(data =>
        data.index === Crypto_22.defaultData.index
    )[0];
