...
import crypto_07_contract from '../../components/crypto/contract/crypto_01_contract';
...
class Crypto_07 extends Component {
    ...
    static fetchContract(){
        return fetchCryptoContract(crypto_07_contract);
    }
...
const mapStateToProps = (state) => {
    ...
    return {
        data: crypto.filter(data =>
            data.name.toLowerCase() === Crypto_07.defaultData.name.toLowerCase()
        )[0],
