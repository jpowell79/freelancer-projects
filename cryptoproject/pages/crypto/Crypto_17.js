...
import crypto_17_contract from '../../components/crypto/contract/crypto_17_contract';
...
class Crypto_17 extends Component {
    static defaultData = getDefaultCrypto({index: 17});
...
const mapStateToProps = (state) => {
    ...
    let cryptoData = crypto.filter(data =>
        data.index === Crypto_17.defaultData.index
    )[0];
