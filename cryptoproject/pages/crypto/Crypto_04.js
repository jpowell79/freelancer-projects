...
import crypto_04_contract from '../../components/crypto/contract/crypto_01_contract';
...
class Crypto_04 extends Component {
    ...
    static fetchContract(){
        return fetchCryptoContract(crypto_04_contract);
    }
...
const mapStateToProps = (state) => {
    ...
    return {
        data: crypto.filter(data =>
            data.name.toLowerCase() === Crypto_04.defaultData.name.toLowerCase()
        )[0],
